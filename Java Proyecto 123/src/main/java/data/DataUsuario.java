...
public class DataUsuario
{
	...
	try
	{
	    stmt = DbConnector.getInstancia().getConn()
		    .prepareStatement("select id,nombre_usuario,email,nickname,fecha_nacimiento,telefono,tipo" + " from usuario where id=?");
...
>>>>>>> branch 'main' of git@github.com:Juan-Pablo-Barrientos/Java-Proyecto.git
	...
	try
	{
	    stmt = DbConnector.getInstancia().getConn().prepareStatement("select id,nombre_usuario,email,nickname,fecha_nacimiento,telefono,tipo"
...
>>>>>>> branch 'main' of git@github.com:Juan-Pablo-Barrientos/Java-Proyecto.git
	...
	try
	{
	    stmt = DbConnector.getInstancia().getConn().prepareStatement("delete from usuario where id=?");
